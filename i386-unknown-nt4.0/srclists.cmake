...
set (SOURCE_LIST_0 
	${SRC}/mutatee_driver.c	${SRC}/proccontrol/pc_mem_perm_mutatee.c
...
set (SOURCE_LIST_5 
	${SRC}/mutatee_driver.c	${PROJECT_SOURCE_DIR}/i386-unknown-nt4.0/symtab_group_test_group.c
...
set (SOURCE_LIST_7 
	${SRC}/mutatee_driver.c	${PROJECT_SOURCE_DIR}/i386-unknown-nt4.0/dyninst_group_test_group.c
	${SRC}/dyninst/test1_1_mutatee.c
 	...
 	${SRC}/dyninst/test1_15_mutatee.c
...
set (SOURCE_LIST_18 
	${SRC}/mutatee_driver.c	${SRC}/dyninst/test_reloc_mutatee.c
 	${SRC}/mutatee_util.c
 )
set (SOURCE_LIST_19 
...
set (SOURCE_LIST_25 
	${SRC}/mutatee_driver.c	${PROJECT_SOURCE_DIR}/i386-unknown-nt4.0/dyninst_cxx_group_test_group.c
...
set_property (SOURCE ${SRC}/dyninst/test1_15_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS TEST_NAME=test1_15)
set_property (SOURCE ${SRC}/dyninst/test1_15_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS GROUPABLE=1)
...
set_property (SOURCE ${SRC}/proccontrol/pc_mem_perm_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS TEST_NAME=pc_mem_perm)
set_property (SOURCE ${SRC}/proccontrol/pc_mem_perm_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS GROUPABLE=0)
...
set_property (SOURCE ${SRC}/dyninst/test_reloc_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS TEST_NAME=test_reloc)
set_property (SOURCE ${SRC}/dyninst/test_reloc_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS GROUPABLE=0)
