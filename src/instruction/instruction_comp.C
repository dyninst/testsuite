...
test_results_t InstructionComponent::program_setup(ParameterDict &)
{
   return PASSED;
}

test_results_t InstructionComponent::program_teardown(ParameterDict &)
{
   return PASSED;
}

test_results_t InstructionComponent::group_setup(RunGroup *, ParameterDict &)
{
   return PASSED;
}

test_results_t InstructionComponent::group_teardown(RunGroup *, ParameterDict &)
{
   return PASSED;
}

test_results_t InstructionComponent::test_setup(TestInfo *, ParameterDict &)
{
   return PASSED;
}

test_results_t InstructionComponent::test_teardown(TestInfo *, ParameterDict &)
{
   return PASSED;
}

test_results_t InstructionMutator::setup(ParameterDict &)
{
  return PASSED;
}
                                      ...
                                      const registerSet& expectedWritten)
{
    ...
    Dyninst::Architecture a = i.getArch();
