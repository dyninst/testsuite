...
/* $Id: test1_11F_mutatee.c,v 1.1 2008/10/30 19:17:31 legendre Exp $ */
...
extern void test1_11f_init_globals ();
extern void test1_11_func1 ();
...
int test1_11F_mutatee() {
  ...
  if (test1_11f_globals.passedTest_) {
