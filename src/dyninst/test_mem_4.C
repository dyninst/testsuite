...
// $Id: test_mem_4.C,v 1.1 2008/10/30 19:21:57 legendre Exp $
/*
 * #Name: test6_4
...
class test_mem_4_Mutator : public DyninstMutator {
public:
  virtual test_results_t executeTest();
};
extern "C" DLLEXPORT TestMutator *test_mem_4_factory() {
  return new test_mem_4_Mutator();
}
...
// External Interface
// extern "C" TEST_DLL_EXPORT int test6_4_mutatorMAIN(ParameterDict &param)
// {
//     BPatch *bpatch;
