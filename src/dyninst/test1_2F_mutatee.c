...
/* $Id: test1_2F_mutatee.c,v 1.1 2008/10/30 19:18:52 legendre Exp $ */
...
#define test1_2_func2_1 test1_2_func2_1_
#define test1_2f_init_globals test1_2f_init_globals_
#define test1_2f_globals test1_2f_globals_

extern struct block_ test1_2f_globals;

extern void test1_2f_init_globals ();
extern void test1_2_func2_1 ();
...
int test1_2F_mutatee() {
    ...
    if (test1_2f_globals.passedTest_) {
