...
/* $Id: test1_20F_mutatee.c,v 1.1 2008/10/30 19:18:21 legendre Exp $ */
...
extern void test1_20f_init_globals ();
...
int test1_20F_mutatee() {
  ...
  if (test1_20f_globals.passedTest_) {
