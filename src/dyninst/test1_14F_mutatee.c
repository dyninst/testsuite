...
/* $Id: test1_14F_mutatee.c,v 1.1 2008/10/30 19:17:46 legendre Exp $ */
...
extern void test1_14f_init_globals ();
extern void test1_14_func1 ();
...
int test1_14F_mutatee() {
  ...
  if (test1_14f_globals.passedTest_) {
