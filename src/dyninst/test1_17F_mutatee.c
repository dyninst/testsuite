...
/* $Id: test1_17F_mutatee.c,v 1.1 2008/10/30 19:18:01 legendre Exp $ */
...
extern void test1_17f_init_globals ();
extern void test1_17_func1 ();
...
int test1_17F_mutatee() {
  ...
  if (test1_17f_globals.passedTest_) {
