...
/* $Id: test1_10F_mutatee.c,v 1.1 2008/10/30 19:17:26 legendre Exp $ */
...
extern void test1_10f_init_globals ();
extern void test1_10_func1 ();
...
int test1_10F_mutatee() {
  ...
  if (test1_10f_globals.passedTest_) {
