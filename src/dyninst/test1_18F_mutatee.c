...
/* $Id: test1_18F_mutatee.c,v 1.1 2008/10/30 19:18:06 legendre Exp $ */
...
extern void test1_18f_init_globals();
extern void test1_18_func1();
...
int test1_18F_mutatee() {
  ...
  if (test1_18f_globals.passedTest_ ) {
