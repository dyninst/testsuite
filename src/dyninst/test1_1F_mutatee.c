...
/* $Id: test1_1F_mutatee.c,v 1.1 2008/10/30 19:18:15 legendre Exp $ */
...
/* These functions are in the Fortran component */
extern void test1_1f_init_globals ();
extern void test1_1_func1_1 ();
...
int test1_1F_mutatee() {
    test1_1f_globals.passedTest_ = FALSE;

    /* Before I call any of the Fortan component functions, I need to set up
     * the output.  The Fortran components print to stdout, not the log file.
