...
set (SOURCE_LIST_6 
	${SRC}/mutatee_driver.c	${PROJECT_SOURCE_DIR}/x86_64-unknown-linux2.4/dyninst_group_test_group.c
...
set (SOURCE_LIST_43 
	${SRC}/mutatee_driver.c	${PROJECT_SOURCE_DIR}/x86_64-unknown-linux2.4/dyninst_cxx_group_test_group.c
...
set (SOURCE_LIST_66 
	${SRC}/mutatee_driver.c	${PROJECT_SOURCE_DIR}/x86_64-unknown-linux2.4/symtab_group_test_group.c
...
set_property (SOURCE ${SRC}/dyninst/amd64_7_arg_call_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS TEST_NAME=amd64_7_arg_call)
set_property (SOURCE ${SRC}/dyninst/amd64_7_arg_call_mutatee.c APPEND PROPERTY COMPILE_DEFINITIONS GROUPABLE=0)
